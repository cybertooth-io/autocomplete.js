  ...
  return (function (a) {
    ...
    function (a, b, c) {
      ...
      var g = "aaAutocomplete",
        ...
        i = c(6);
      (d.sources = h.sources),
        (d.escapeHighlightedString = f.escapeHighlightedString);
      ...
      !(function (b, c) {
        a.exports = (function (a) {
          var b = (function () {
            ...
            function g(a) {
              return (
                f(a) && !d(a) && Object.getPrototypeOf(a) == Object.prototype
              );
            }
            function h(a) {
            ...
            return (
              ...
              (X.fragment = function (a, b, c) {
                var d, e, f;
                return (
                  M.test(a) && (d = z(H.createElement(RegExp.$1))),
                  d ||
                    (a.replace &&
                      (a = a.replace(
                    ...
                    b === x && (b = L.test(a) && RegExp.$1),
                    b in S || (b = "*"),
                    (f = S[b]),
                    (f.innerHTML = "" + a),
                    (d = z.each(G.call(f.childNodes), function () {
                      f.removeChild(this);
                    }))),
                  g(c) &&
                    ((e = z(d)),
                    z.each(c, function (a, b) {
              ...
              (X.init = function (a, b) {
                ...
                if (!a) return X.Z();
                if ("string" == typeof a)
                  if (((a = a.trim()), "<" == a[0] && L.test(a)))
                    (d = X.fragment(a, RegExp.$1, b)), (a = null);
                  else {
                  ...
                  if ($(a)) d = i(a);
                    ...
                    (d = X.fragment(a.trim(), RegExp.$1, b)), (a = null);
                  else {
                    if (b !== x) return z(b).find(a);
                    d = X.qsa(H, a);
                  }
              ...
              (X.qsa = function (a, b) {
                ...
                return a.getElementById && g && d
                  ...
                  ? []
                  : G.call(
                      g && !d && a.getElementsByClassName
                        ? e
                          ? a.getElementsByClassName(f)
                          : a.getElementsByTagName(b)
                        : a.querySelectorAll(b)
                    );
              }),
              (z.contains = H.documentElement.contains
                ? function (a, b) {
              ...
              (z.map = function (a, b) {
                ...
                if (h(a))
                  for (d = 0; d < a.length; d++)
                    null != (c = b(a[d], d)) && f.push(c);
                else for (e in a) null != (c = b(a[e], e)) && f.push(c);
                return j(f);
              }),
              (z.each = function (a, b) {
                var c, d;
              ...
              (z.fn = {
                ...
                concat: function () {
                  ...
                  for (a = 0; a < arguments.length; a++)
                    (b = arguments[a]), (c[a] = X.isZ(b) ? b.toArray() : b);
                  return E.apply(X.isZ(this) ? this.toArray() : this, c);
                },
                map: function (a) {
                  return z(
                    z.map(this, function (b, c) {
                      return a.call(b, c, b);
                    })
                  );
                },
                ...
                each: function (a) {
                  return (
                    D.every.call(this, function (b, c) {
                ...
                closest: function (a, b) {
                  ...
                  return (
                    this.each(function (f, g) {
                      for (; g && !(d ? d.indexOf(g) >= 0 : X.matches(g, a)); )
                        g = g !== b && !e(g) && g.parentNode;
                ...
                parents: function (a) {
                  for (var b = [], c = this; c.length > 0; )
                    c = z.map(c, function (a) {
                      if ((a = a.parentNode) && !e(a) && b.indexOf(a) < 0)
                        return b.push(a), a;
                    });
                  return r(b, a);
                },
                    ...
                    "none" == this.style.display && (this.style.display = ""),
                      "none" ==
                        getComputedStyle(this, "").getPropertyValue(
                          "display"
                        ) && (this.style.display = n(this.nodeName));
                  });
                },
                ...
                wrap: function (a) {
                  ...
                  return this.each(function (c) {
                    z(this).wrapAll(
                      b ? a.call(this, c) : e ? d.cloneNode(!0) : d
                    );
                  });
                },
                wrapAll: function (a) {
                ...
                toggle: function (a) {
                  return this.each(function () {
                    var b = z(this);
                    (a === x ? "none" == b.css("display") : a)
                      ? b.show()
                      : b.hide();
                  });
                },
                prev: function (a) {
                  return z(this.pluck("previousElementSibling")).filter(
                    a || "*"
                  );
                },
                next: function (a) {
                ...
                attr: function (a, b) {
                  ...
                  return "string" != typeof a || 1 in arguments
                    ? this.each(function (c) {
                        if (1 === this.nodeType)
                          if (f(a)) for (y in a) t(this, y, a[y]);
                          else t(this, a, s(this, b, c, this.getAttribute(a)));
                      })
                    : 0 in this &&
                      1 == this[0].nodeType &&
                      null != (c = this[0].getAttribute(a))
                    ? c
                    : x;
                },
                ...
                offset: function (b) {
                  ...
                  if (
                    ...
                    !z.contains(H.documentElement, this[0])
                  )
                    return { top: 0, left: 0 };
                ...
                css: function (a, c) {
                  if (arguments.length < 2) {
                    ...
                    if ("string" == typeof a) {
                      ...
                      return (
                        d.style[B(a)] ||
                        getComputedStyle(d, "").getPropertyValue(a)
                      );
                    }
                    if ($(a)) {
                      if (!d) return;
                  ...
                  if (this.length) {
                    var a = this[0],
                      ...
                      d = N.test(b[0].nodeName)
                        ...
                        : b.offset();
                    return (
                      (c.top -= parseFloat(z(a).css("margin-top")) || 0),
                      (c.left -= parseFloat(z(a).css("margin-left")) || 0),
                      (d.top +=
                        parseFloat(z(b[0]).css("border-top-width")) || 0),
                      (d.left +=
                        parseFloat(z(b[0]).css("border-left-width")) || 0),
              ...
              P.forEach(function (c, d) {
                ...
                (z.fn[c] = function () {
                            ...
                            i &&
                              w(b, function (b) {
                                if (
                                  !(
                                    null == b.nodeName ||
                                    "SCRIPT" !== b.nodeName.toUpperCase() ||
                                    (b.type && "text/javascript" !== b.type) ||
                                    b.src
                                  )
                                ) {
                  ...
                  (z.fn[
                    e ? c + "To" : "insert" + (d ? "Before" : "After")
                  ] = function (a) {
                    return z(a)[c](this), this;
                  });
              }),
              (X.Z.prototype = p.prototype = z.fn),
              (X.uniq = C),
              (X.deserializeValue = v),
              (z.zepto = X),
              z
            );
          })();
          return (
            (function (b) {
                ...
                d.split(/\s/).forEach(function (c) {
                  ...
                  (d.proxy = function (b) {
                    if (((b = k(b)), !b.isImmediatePropagationStopped())) {
                      ...
                      var d = o.apply(
                        a,
                        b._args == m ? [b] : [b].concat(b._args)
                      );
                      return (
                        d === !1 && (b.preventDefault(), b.stopPropagation()), d
                      );
                    }
                  }),
                    (d.i = p.length),
                    ...
                    "addEventListener" in a &&
                      a.addEventListener(h(d.e), d.proxy, g(d, n));
                });
              }
                  ...
                  d(a, b, e, f).forEach(function (b) {
                    delete r[j][b.i],
                      "removeEventListener" in a &&
                        a.removeEventListener(h(b.e), b.proxy, g(b, i));
                  });
                });
              }
              function k(a, c) {
                ...
                (b.proxy = function (a, d) {
                  ...
                  if (p(a)) {
                    var f = function () {
                      return a.apply(
                        d,
                        e ? e.concat(o.call(arguments)) : arguments
                      );
                    };
                    return (f._zid = c(a)), f;
                  }
                  if (q(d))
                    return e
                      ? (e.unshift(a[d], a), b.proxy.apply(null, e))
                      : b.proxy(a[d], a);
              ...
              (b.fn.delegate = function (a, b, c) {
                      ...
                      k.each(function (k, m) {
                        f &&
                          ...
                          c &&
                            (h = function (a) {
                              var d,
                                f = b(a.target).closest(c, m).get(0);
                              if (f && f !== m)
                                return (
                                  (d = b.extend(l(a), {
                                    currentTarget: f,
                ...
                (b.fn.trigger = function (a, c) {
                  return (
                    (a = q(a) || b.isPlainObject(a) ? b.Event(a) : k(a)),
                    (a._args = c),
                    this.each(function () {
                      a.type in u && "function" == typeof this[a.type]
                        ? this[a.type]()
                        : "dispatchEvent" in this
                        ? this.dispatchEvent(a)
                        : b(this).triggerHandler(a, c);
                    })
                  );
                }),
                  ...
                  return (
                    this.each(function (g, h) {
                      (e = l(q(a) ? b.Event(a) : a)),
                        (e._args = c),
                        (e.target = h),
                        b.each(d(h, a.type || a), function (a, b) {
                          if (
                            ((f = b.proxy(e)),
            ...
            (function (a) {
              ...
              function d(b) {
                var c = {};
                return (
                  a.each(b.attributes || i, function (b, d) {
                    0 == d.name.indexOf("data-") &&
                      (c[
                        g(d.name.replace("data-", ""))
                      ] = a.zepto.deserializeValue(d.value));
                  }),
                  c
                );
              }
      ...
      a.exports = {
        ...
        cloneDeep: function (a) {
          var b = this.mixin({}, a),
            c = this;
          return (
            this.each(b, function (a, d) {
              a &&
                (c.isArray(a)
                  ? (b[d] = [].concat(a))
                  : c.isObject(a) && (b[d] = c.cloneDeep(a)));
            }),
            b
          );
        },
        ...
        escapeHighlightedString: function (a, b, c) {
          ...
          return (
            ...
            g.innerHTML
              .replace(RegExp(d(e.innerHTML), "g"), b)
              .replace(RegExp(d(f.innerHTML), "g"), c)
          );
        },
      };
    },
    function (a, b, c) {
      ...
      function d(a) {
        ...
        if (
          ((a = a || {}),
          a.input || i.error("missing input"),
          (this.isActivated = !1),
          (this.debug = !!a.debug),
          (this.autoselect = !!a.autoselect),
          (this.autoselectOnBlur = !!a.autoselectOnBlur),
          (this.openOnFocus = !!a.openOnFocus),
          (this.minLength = i.isNumber(a.minLength) ? a.minLength : 1),
          (this.autoWidth = void 0 === a.autoWidth || !!a.autoWidth),
          (this.clearOnSelected = !!a.clearOnSelected),
          (this.tabAutocomplete =
            void 0 === a.tabAutocomplete || !!a.tabAutocomplete),
          (a.hint = !!a.hint),
          a.hint && a.appendTo)
        )
          throw new Error(
        ...
        (this.css = a.css = i.mixin({}, o, a.appendTo ? o.appendTo : {})),
          (this.cssClasses = a.cssClasses = i.mixin(
            {},
            o.defaultClasses,
            a.cssClasses || {}
          )),
          (this.cssClasses.prefix = a.cssClasses.formattedPrefix = i.formatPrefix(
            this.cssClasses.prefix,
            this.cssClasses.noPrefix
          )),
          (this.listboxId = a.listboxId = [
        ...
        (b = f.menu),
          (c = f.hint),
          a.dropdownMenuContainer &&
            j
              .element(a.dropdownMenuContainer)
              .css("position", "relative")
              .append(b.css("top", "0")),
          g.on("blur.aa", function (a) {
            var c = document.activeElement;
            i.isMsie() &&
              (b[0] === c || b[0].contains(c)) &&
              (a.preventDefault(),
          ...
          (this.eventBus = a.eventBus || new k({ el: g })),
          ...
          (this.input = new d.Input({ input: g, hint: c })
      ...
      function e(a) {
        ...
        (b = j.element(a.input)),
          (c = j
            .element(n.wrapper.replace("%ROOT%", a.cssClasses.root))
            .css(a.css.wrapper)),
          a.appendTo ||
            "block" !== b.css("display") ||
            "table" !== b.parent().css("display") ||
            c.css("display", "table-cell");
        var g = n.dropdown
          .replace("%PREFIX%", a.cssClasses.prefix)
          .replace("%DROPDOWN_MENU%", a.cssClasses.dropdownMenu);
        (d = j
          .element(g)
          .css(a.css.dropdown)
          .attr({ role: "listbox", id: a.listboxId })),
          a.templates &&
            a.templates.dropdownMenu &&
            d.html(i.templatify(a.templates.dropdownMenu)()),
          (e = b.clone().css(a.css.hint).css(f(b))),
          e
            .val("")
            .addClass(i.className(a.cssClasses.prefix, a.cssClasses.hint, !0))
          ...
          b
            .addClass(i.className(a.cssClasses.prefix, a.cssClasses.input, !0))
            .attr({
              autocomplete: "off",
              spellcheck: !1,
              role: "combobox",
              "aria-autocomplete":
                a.datasets && a.datasets[0] && a.datasets[0].displayKey
                  ? "both"
                  : "list",
              "aria-expanded": "false",
        ...
        return (
          (c = a.appendTo
            ? c.appendTo(j.element(a.appendTo).eq(0)).eq(0)
            : b.wrap(c).parent()),
          c.prepend(a.hint ? e : null).append(d),
          { wrapper: c, input: b, hint: e, menu: d }
        );
      }
      function f(a) {
        return {
      ...
      function g(a, b) {
        ...
        i.each(c.data(h), function (a, b) {
          ...
          c
            .detach()
            .removeClass(i.className(b.prefix, b.input, !0))
            .insertAfter(a),
          c.removeData && c.removeData(h),
          a.remove();
      }
      var h = "aaAttrs",
        i = c(4),
      ...
      i.mixin(d.prototype, {
            ...
            i.each(a.keyboardShortcuts, function (a) {
              ...
              j.element(document).keydown(function (a) {
                ...
                if (
                  ...
                  c.indexOf(f) !== -1 &&
                    (b.focus(), a.stopPropagation(), a.preventDefault());
                }
              });
          }
        },
        ...
        _onCursorMoved: function (a, b) {
          ...
          this.input.setActiveDescendant(d),
            c &&
              (b && this.input.setInputValue(c.value, !0),
              this.eventBus.trigger("cursorchanged", c.raw, c.datasetName));
        },
        ...
        _onBlurred: function () {
          var a, b;
          (a = this.dropdown.getDatumForCursor()),
            (b = this.dropdown.getDatumForTopSuggestion());
          var c = { selectionMethod: "blur" };
          this.debug ||
            (this.autoselectOnBlur && a
              ? this._select(a, c)
              : this.autoselectOnBlur && b
              ? this._select(b, c)
              : ((this.isActivated = !1),
                this.dropdown.empty(),
                this.dropdown.close()));
        ...
        _onEnterKeyed: function (a, b) {
          ...
          c
            ? (this._select(c, e), b.preventDefault())
            : this.autoselect && d && (this._select(d, e), b.preventDefault());
        },
        _onTabKeyed: function (a, b) {
          if (!this.tabAutocomplete) return void this.dropdown.close();
          var c,
            d = { selectionMethod: "tabKey" };
          (c = this.dropdown.getDatumForCursor())
            ? (this._select(c, d), b.preventDefault())
          ...
          (a = this.dropdown.getDatumForTopSuggestion()),
            a && this.dropdown.isVisible() && !this.input.hasOverflow()
              ? ((b = this.input.getInputValue()),
                (c = l.normalizeQuery(b)),
                (d = i.escapeRegExChars(c)),
                (e = new RegExp("^(?:" + d + ")(.+$)", "i")),
                (f = e.exec(a.value)),
                f ? this.input.setHint(b + f[1]) : this.input.clearHint())
              : this.input.clearHint();
        },
        ...
        _select: function (a, b) {
          void 0 !== a.value && this.input.setQuery(a.value),
            this.clearOnSelected
              ? this.setVal("")
              : this.input.setInputValue(a.value, !0),
            this._setLanguageDirection(),
            this.eventBus
              .trigger("selected", a.raw, a.datasetName, b)
    ...
    function (a, b, c) {
      "use strict";
      function d(a) {
        (a && a.el) || e.error("EventBus initialized without el"),
          (this.$el = f.element(a.el));
      }
      var e = c(4),
        f = c(3);
      e.mixin(d.prototype, {
    ...
    function (a, b, c) {
      ...
      function d(a) {
        var b,
          ...
          g = this;
        (a = a || {}),
          a.input || i.error("input is missing"),
          (b = i.bind(this._onBlur, this)),
          (c = i.bind(this._onFocus, this)),
          (d = i.bind(this._onKeydown, this)),
          (f = i.bind(this._onInput, this)),
          (this.$hint = j.element(a.hint)),
          (this.$input = j
            .element(a.input)
            .on("blur.aa", b)
            .on("focus.aa", c)
        ...
        i.mixin(d.prototype, k, {
          ...
          _checkInputValue: function () {
            ...
            (a = this.getInputValue()),
              (b = f(a, this.query)),
              (c = !(!b || !this.query) && this.query.length !== a.length),
              (this.query = a),
              b
    ...
    function (a, b, c) {
      ...
      function h(a) {
        ...
        if (!this._callbacks) return this;
        for (
          a = a.split(l), d = [].slice.call(arguments, 1);
          (b = a.shift()) && (c = this._callbacks[b]);

        )
          (e = i(c.sync, this, [b].concat(d))),
            (f = i(c.async, this, [b].concat(d))),
            e() && k(f);
        return this;
      }
      function i(a, b, c) {
    ...
    function (a, b, c) {
      ...
      function d() {
        h &&
          i &&
          ((h = !1), i.length ? (m = i.concat(m)) : (l = -1), m.length && e());
      }
      function e() {
        if (!h) {
          (n = !1), (h = !0);
    ...
    function (a, b, c) {
      ...
      function d(a) {
        var b,
          ...
          h = this;
        (a = a || {}),
          a.menu || f.error("menu is required"),
          f.isArray(a.datasets) ||
            f.isObject(a.datasets) ||
            f.error("1 or more datasets required"),
          a.datasets || f.error("datasets is required"),
          (this.isOpen = !1),
          (this.isEmpty = !0),
          (this.minLength = a.minLength || 0),
          (this.templates = {}),
          (this.appendTo = a.appendTo || !1),
          (this.css = f.mixin({}, j, a.appendTo ? j.appendTo : {})),
          (this.cssClasses = a.cssClasses = f.mixin(
            {},
            j.defaultClasses,
            a.cssClasses || {}
          )),
          (this.cssClasses.prefix =
            a.cssClasses.formattedPrefix ||
            f.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix)),
          (b = f.bind(this._onSuggestionClick, this)),
          (c = f.bind(this._onSuggestionMouseEnter, this)),
          (d = f.bind(this._onSuggestionMouseLeave, this));
        var i = f.className(this.cssClasses.prefix, this.cssClasses.suggestion);
        (this.$menu = g
          .element(a.menu)
          .on("mouseenter.aa", i, c)
          .on("mouseleave.aa", i, d)
          .on("click.aa", i, b)),
          (this.$container = a.appendTo ? a.wrapper : this.$menu),
          a.templates &&
            a.templates.header &&
            ((this.templates.header = f.templatify(a.templates.header)),
            this.$menu.prepend(this.templates.header())),
          a.templates &&
            a.templates.empty &&
            ((this.templates.empty = f.templatify(a.templates.empty)),
            (this.$empty = g.element(
              '<div class="' +
                f.className(this.cssClasses.prefix, this.cssClasses.empty, !0) +
                '"></div>'
            )),
            this.$menu.append(this.$empty),
            this.$empty.hide()),
          (this.datasets = f.map(a.datasets, function (b) {
            return e(h.$menu, b, a.cssClasses);
          })),
          f.each(this.datasets, function (a) {
            var b = a.getRoot();
            b && 0 === b.parent().length && h.$menu.append(b),
              a.onSync("rendered", h._onRendered, h);
          }),
          a.templates &&
            a.templates.footer &&
            ((this.templates.footer = f.templatify(a.templates.footer)),
      ...
      f.mixin(d.prototype, h, {
        ...
        _onSuggestionMouseEnter: function (a) {
          ...
          if (
            !b.hasClass(
              f.className(this.cssClasses.prefix, this.cssClasses.cursor, !0)
            )
          ) {
            this._removeCursor();
            var c = this;
        ...
        _onRendered: function (a, b) {
          ...
          if (((this.isEmpty = f.every(this.datasets, c)), this.isEmpty))
            if (
              (b.length >= this.minLength && this.trigger("empty"), this.$empty)
            )
            ...
            this.isOpen &&
              ...
              b.length >= this.minLength ? this._show() : this._hide());
        ...
        _getSuggestions: function () {
          return this.$menu.find(
            f.className(this.cssClasses.prefix, this.cssClasses.suggestion)
          );
        },
        _getCursor: function () {
          return this.$menu
            .find(f.className(this.cssClasses.prefix, this.cssClasses.cursor))
            .first();
        },
        ...
        _moveCursor: function (a) {
          ...
          if (this.isOpen) {
            if (
              ...
              this._removeCursor(),
              (d = b.index(c) + a),
              (d = ((d + 1) % (b.length + 1)) - 1) === -1)
            )
              return void this.trigger("cursorRemoved");
            d < -1 && (d = b.length - 1),
              this._setCursor((e = b.eq(d)), !0),
    ...
    function (a, b, c) {
      ...
      function d(a) {
        (a = a || {}),
          ...
          a.source || k.error("missing source"),
          a.name && !g(a.name) && k.error("invalid dataset name: " + a.name),
          (this.query = null),
          (this._isEmpty = !0),
          (this.highlight = !!a.highlight),
          (this.name =
            void 0 === a.name || null === a.name ? k.getUniqueId() : a.name),
          (this.source = a.source),
          (this.displayFn = e(a.display || a.displayKey)),
          (this.debounce = a.debounce),
          (this.cache = a.cache !== !1),
          (this.templates = f(a.templates, this.displayFn)),
          (this.css = k.mixin({}, n, a.appendTo ? n.appendTo : {})),
          (this.cssClasses = a.cssClasses = k.mixin(
            {},
            n.defaultClasses,
            a.cssClasses || {}
          )),
          (this.cssClasses.prefix =
            a.cssClasses.formattedPrefix ||
            k.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix));
        var b = k.className(this.cssClasses.prefix, this.cssClasses.dataset);
        (this.$el =
          a.$menu && a.$menu.find(b + "-" + this.name).length > 0
            ? l.element(a.$menu.find(b + "-" + this.name)[0])
            : l.element(
                m.dataset
        ...
        k.mixin(d.prototype, o, {
          _render: function (a, b) {
            function c() {
              ...
              return (
                (b = [{ query: a, isEmpty: !0 }].concat(b)),
                n.templates.empty.apply(this, b)
              );
            }
            function d() {
              function a(a) {
                var b,
                  c = m.suggestion
                    ...
                    .replace("%SUGGESTION%", f.cssClasses.suggestion);
                return (
                  (b = l
                    .element(c)
                    .attr({
                    ...
                    .append(n.templates.suggestion.apply(this, [a].concat(e)))),
                  b.data(h, n.name),
                  b.data(i, n.displayFn(a) || void 0),
                  b.data(j, JSON.stringify(a)),
              ...
              return (
                (c = l.element(g).css(this.css.suggestions)),
                (d = k.map(b, a)),
                c.append.apply(c, d),
                c
              );
            ...
            function e() {
              var b = [].slice.call(arguments, 0);
              return (
                (b = [{ query: a, isEmpty: !g }].concat(b)),
                n.templates.header.apply(this, b)
              );
            }
            function f() {
              var b = [].slice.call(arguments, 0);
              return (
                (b = [{ query: a, isEmpty: !g }].concat(b)),
                n.templates.footer.apply(this, b)
              );
            }
            if (this.$el) {
              var g,
              ...
              if (
                ...
                (g = b && b.length),
                (this._isEmpty = !g),
                !g && this.templates.empty)
              )
                this.$el
                  .html(c.apply(this, o))
                  .prepend(n.templates.header ? e.apply(this, o) : null)
                  .append(n.templates.footer ? f.apply(this, o) : null);
              else if (g)
                this.$el
                  .html(d.apply(this, o))
                  .prepend(n.templates.header ? e.apply(this, o) : null)
          ...
          update: function (a) {
            function b(b) {
              if (!this.canceled && a === this.query) {
                ...
                this.cacheSuggestions(a, b, c),
                  this._render.apply(this, [a, b].concat(c));
              }
            }
            if (
              ((this.query = a),
              (this.canceled = !1),
              this.shouldFetchFromCache(a))
            )
              b.apply(
                this,
              ...
              if (this.debounce) {
                ...
                clearTimeout(this.debounceTimeout),
                  (this.debounceTimeout = setTimeout(e, this.debounce));
              } else d();
            }
          },
          cacheSuggestions: function (a, b, c) {
            (this.cachedQuery = a),
              (this.cachedSuggestions = b),
              (this.cachedRenderExtraArgs = c);
          },
        ...
        g = (function () {
          function a(a, d) {
            return window.Promise.resolve()
              .then(function () {
                return b.length && ((e = a.search(b)), (b = [])), e;
              })
              .then(function (a) {
                if (a) return (c = a.results), c[d];
              });
          }
          var b = [],
            c = [],
          ...
          return function (c, e) {
            return function (f, g) {
              a(
                c.as,
                b.push({ indexName: c.indexName, query: f, params: e }) - 1
              )
                .then(function (a) {
                  a && g(a.hits, a);
                })
    ...
    function (a, b) {
      ...
      a.exports = function (a) {
        var b =
          a.match(/Algolia for JavaScript \((\d+\.)(\d+\.)(\d+)\)/) ||
          a.match(/Algolia for vanilla JavaScript (\d+\.)(\d+\.)(\d+)/);
      ...
      a.exports = function (a, b, c, g) {
            ...
            if (h.hits.length > 0) {
              ...
              return (
                n &&
                  n[0] >= 3 &&
                  n[1] > 20 &&
                  (b.additionalUA = "autocomplete.js " + e),
                void k.search(j(l), m, function (a, b) {
                  if (a) return void d.error(a.message);
                  var c = [];
                  if (g.includeAll) {
        ...
        if (
          (i &&
            i[0] >= 3 &&
            i[1] > 20 &&
            ((b = b || {}), (b.additionalUA = "autocomplete.js " + e)),
          !c.source)
        )
          return d.error("Missing 'source' key");
        var j = d.isFunction(c.source)
          ? c.source
          : function (a) {
              return a[c.source];
            };
