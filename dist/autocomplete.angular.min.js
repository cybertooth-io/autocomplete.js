...
!(function (a) {
  ...
  function (a, b, c) {
    "use strict";
    var d = c(2);
    c(3).element = d.element;
    var e = c(4);
    (e.isArray = d.isArray),
      (e.isFunction = d.isFunction),
      (e.isObject = d.isObject),
      (e.bind = d.element.proxy),
      (e.each = d.forEach),
      (e.map = d.element.map),
      (e.mixin = d.extend),
      (e.Event = d.element.Event);
    var f = c(5),
      g = c(6);
    d.module("algolia.autocomplete", []).directive("autocomplete", [
      "$parse",
      "$injector",
      function (a, b) {
        try {
          (b.get("algolia").sources = g.sources),
            (b.get("algolia").escapeHighlightedString =
              e.escapeHighlightedString);
        } catch (a) {}
        return {
          restrict: "AC",
          scope: { options: "&aaOptions", datasets: "&aaDatasets" },
          link: function (b, c, e) {
            function h() {
              j && j.destroy(),
                (j = new g({
                  input: c,
                  dropdownMenuContainer: b.options.dropdownMenuContainer,
                  eventBus: i,
                  hint: b.options.hint,
                  minLength: b.options.minLength,
                  autoselect: b.options.autoselect,
                  autoselectOnBlur: b.options.autoselectOnBlur,
                  tabAutocomplete: b.options.tabAutocomplete,
                  openOnFocus: b.options.openOnFocus,
                  templates: b.options.templates,
                  debug: b.options.debug,
                  clearOnSelected: b.options.clearOnSelected,
                  cssClasses: b.options.cssClasses,
                  datasets: b.datasets,
                  keyboardShortcuts: b.options.keyboardShortcuts,
                  appendTo: b.options.appendTo,
                  autoWidth: b.options.autoWidth,
                }));
            }
            if (c.hasClass("autocomplete") || "" === e.autocomplete) {
              (e = e),
                (b.options = a(b.options)(b)),
                b.options || (b.options = {}),
                (b.datasets = a(b.datasets)(b)),
                b.datasets &&
                  !d.isArray(b.datasets) &&
                  (b.datasets = [b.datasets]);
              var i = new f({ el: c }),
                j = null;
              b.$watch("options", h),
                d.isArray(b.datasets)
                  ? b.$watchCollection("datasets", h)
                  : b.$watch("datasets", h),
                c.bind("autocomplete:selected", function (a, c, d) {
                  b.$emit("autocomplete:selected", c, d);
                }),
                c.bind("autocomplete:autocompleted", function (a, c, d) {
                  b.$emit("autocomplete:autocompleted", c, d);
                }),
                c.bind("autocomplete:opened", function () {
                  b.$emit("autocomplete:opened");
                }),
                c.bind("autocomplete:closed", function () {
                  b.$emit("autocomplete:closed");
                }),
                c.bind("autocomplete:cursorchanged", function (a, c, d) {
                  b.$emit("autocomplete:cursorchanged", a, c, d);
                });
            }
          },
        };
  ...
  function (a, b, c) {
    ...
    a.exports = {
      ...
      isMsie: function (a) {
        if (
          (void 0 === a && (a = navigator.userAgent), /(msie|trident)/i.test(a))
        ) {
  ...
  function (a, b, c) {
    ...
    d.isMsie() &&
      ...
      d.isMsie() && d.isMsie() <= 7 && d.mixin(e.input, { marginTop: "-1px" }),
      (a.exports = e);
  },
  function (a, b, c) {
    "use strict";
  ...
  function (a, b, c) {
    ...
    var d = c(4),
      ...
      g = (function () {
        ...
        return function (c, e) {
          return function (f, g) {
            a(c.as, b.push({ indexName: c.indexName, query: f, params: e }) - 1)
              .then(function (a) {
                a && g(a.hits, a);
              })
              .catch(function (a) {
